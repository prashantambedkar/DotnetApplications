...
public partial class Runprintlabels : System.Web.UI.Page
{
    ...
    private void grid_view()
    {
        ...
        DataSet ds = objReport.GetUnPrintedLabelHistory(FromDate, ToDate, LocationId, BuildingId, FloorId, CatID, null);
    ...
    private void ExportToExcel()
    {
        ...
        if (gvData.Items.Count > 0)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=UnPrinted_Labels.xls");
            Response.Charset = "";
