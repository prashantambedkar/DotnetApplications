<%@ Page Title="" Language="C#" MasterPageFile="~/adminMasterPage.master" AutoEventWireup="true" CodeFile="AssetMovement.aspx.cs" Inherits="AssetMovement" %>
                                        ...
                                        <div class="form-group">
                                            <div class="container" style="width: 100%">
                                                ...
                                                <div class="row" style="width: 100%">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <asp:Label runat="server" ID="Label1">From Date</asp:Label><br />
                                                        <asp:TextBox ID="txtFrmDate" class="form-control" runat="server"></asp:TextBox>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <asp:Label runat="server" ID="Label2">To Date</asp:Label><br />
                                                    ...
                                                    <div class="col-sm-1">
                                                        ...
                                                        <asp:Button Text="SEARCH" runat="server"
                                                            ID="btnsubmit" OnClick="btnsubmit_Click" class="btn btn-primary form-control" />
                                                    </div>
                                                    <div class="col-sm-1">
                                                        <asp:Label runat="server" ID="Label12">&nbsp;</asp:Label><br />
                                                        <asp:Button Text="CLEAR" runat="server"
                                                            ID="btnRefresh" class="btn btn-danger form-control" OnClick="btnreset_Click" />
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <MasterTableView AllowPaging="True" PageSize="250" AutoGenerateColumns="false" AllowSorting="true"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="LocationName" FilterControlAltText="Filter LocationName column"
                                                HeaderText="LOCATION" SortExpression="LocationName" UniqueName="Location" ReadOnly="true">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="BuildingName" FilterControlAltText="Filter BuildingName column"
                                                HeaderText="BUILDING" SortExpression="BuildingName" UniqueName="Building" ReadOnly="true">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="DepartmentName" FilterControlAltText="Filter DepartmentName column"
                                                HeaderText="DEPARTMENT" SortExpression="DepartmentName" Visible="false" UniqueName="DepartmentName" ReadOnly="true">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="SerialNo" FilterControlAltText="Filter SerialNo column"
                                                HeaderText="SERIAL NO" SortExpression="SerialNo" UniqueName="SerialNo" Visible="false" ReadOnly="true">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="Created_Date" FilterControlAltText="Filter Created_Date column"
                                                HeaderText="Document Movement Date" SortExpression="Created_Date" UniqueName="Created_Date"
                                                ReadOnly="true">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Reason" FilterControlAltText="Filter Reason column"
                                                HeaderText="REASON" SortExpression="Reason" UniqueName="Reason"
                                                ReadOnly="true">
                                            </telerik:GridBoundColumn>
