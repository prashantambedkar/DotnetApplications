<%@ Page Title="" Language="C#" MasterPageFile="~/adminMasterPage.master" AutoEventWireup="true"
    CodeFile="LabelReprint.aspx.cs" Inherits="LabelReprint" %>
            ...
            <div class="panel panel-default">
                    ...
                    <div class="row">
                        <div class="form-inline">
                            ...
                            <div class="btn-group pull-right">
                                <asp:Button ID="btnConfirmPrint" runat="server" Text="PRINT" OnClick="btnConfirmPrint_Click"
                                    OnClientClick="ConfirmBox()" CssClass="btn btn-primary" Style="font-size: 12px; border-radius: 5px" />
                                <%--<asp:Button ID="btnchk" runat="server" Text="Print" OnClientClick="ConfirmBox()" />--%>
                                <%--CssClass="btn"--%>
                            </div>
                            <div class="btn-group pull-right">
                ...
                <div class="panel-body">
                    ...
                    <div class="page-header">
                        <h1><span style="font-family: 'Calibri'; font-size: x-large; color: black;">Reprint</span></h1>
                    </div>
                    <div class="row">
                        <div class="Col-sm-1">
                            <%--                            <label runat="server" id="lblsubcattype" class="col-sm-1 control-label no-padding-right"
                                for="form-field-1"  style="padding-top: 7px;margin-left:10px">
                                Tag Type  :</label>--%>
                        ...
                        <div class="col-sm-3" style=""><h7>Tag Type  :</h7><br />
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <telerik:RadGrid ID="gvData" runat="server" Width="100%" OnNeedDataSource="gvData_NeedDataSource"
                                    ...
                                    OnPageIndexChanged="gvData_PageIndexChanged" OnDataBinding="gvData_DataBinding" BorderWidth="1" OnInit="gvData_Init"
