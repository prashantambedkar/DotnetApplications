<%@ Page Title="" Language="C#" MasterPageFile="~/adminMasterPage.master" AutoEventWireup="true"
    CodeFile="Assettransfer_manual.aspx.cs" Inherits="Assettransfer_manual" %>
...
<%--                    <div class="page-header">
                    ...
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <asp:DropDownList runat="server" ID="cboLoc" AutoPostBack="true" class="form-control" OnSelectedIndexChanged="OnSelectedIndexChangedToLocation">
                                </asp:DropDownList>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <asp:DropDownList runat="server" ID="cboBuild" AutoPostBack="true" class="form-control" OnSelectedIndexChanged="OnSelectedIndexChangedToBuilding">
                                </asp:DropDownList>
                            </div>
                    ...
                    <div class="clearfix form-actions">
                        <div class="col-md-offset-3 col-md-9">
                            <asp:Button Text="Transfer" runat="server" ID="Button1" CssClass="btn" 
