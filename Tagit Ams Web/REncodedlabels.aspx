<%@ Page Title="" Language="C#" MasterPageFile="~/adminMasterPage.master" AutoEventWireup="true"
    CodeFile="REncodedlabels.aspx.cs" Inherits="REncodedlabels" %>
        ...
        <div class="page-content">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="page-header">
                        <h1 style="font-family: 'Calibri'; font-size: x-large; color: black;">Encoded Labels</h1>
                    </div>
                    <div>
                            ...
                            <MasterTableView AllowPaging="True" PageSize="250" AutoGenerateColumns="false" AllowSorting="true">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="Price" FilterControlAltText="Filter Price column"
                                        HeaderText="PRICE" SortExpression="Price" Visible="false" UniqueName="Price" ReadOnly="true">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="SubCatName" Visible="false" FilterControlAltText="Filter SubCategory column"
                                        HeaderText="SUBCATEGORY" SortExpression="SubCatName" UniqueName="SubCategory"
                                        ReadOnly="true">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="DepartmentName" FilterControlAltText="Filter Department column"
                                        HeaderText="DEPARTMENT" Visible="false" SortExpression="DepartmentName" UniqueName="DepartmentName" ReadOnly="true">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn DataField="Column2" FilterControlAltText="Filter Column2 column"
                                        HeaderText="Case Asignee Name" SortExpression="Column2" UniqueName="Column2"
                                        ReadOnly="true">
                                    </telerik:GridBoundColumn>
