<%@ Page Title="" Language="C#" MasterPageFile="~/adminMasterPage.master" AutoEventWireup="true"
    CodeFile="Runprintlabels.aspx.cs" Inherits="Runprintlabels" %>
        ...
        <div class="page-content">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Un-Printed Labels </a></li>
                </ul>
            </div>
            <div class="page-header">
                <h1>
                    Un-Printed Labels</h1>
            </div>
            <!-- /.page-header -->
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="col-xs-12">
                            <%-- <asp:Label ID="lblTotHeader" Text="Total Records." runat="server" Style="font-weight: bold;"></asp:Label>--%>
