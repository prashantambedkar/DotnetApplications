...
public partial class AssetsTaging : System.Web.UI.Page
{
    ...
    protected void gvData_PageIndexChanged(object sender, Telerik.Web.UI.GridPageChangedEventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "gvData_PageIndexChanged", path);
    ...
    protected void gvData_Init(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "gvData_Init", path);
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "Page_Load", path);
    ...
    public void SetGridOrder()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "SetGridOrder", path);
        }
    }
    ...
    private void bindCustodian()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "bindCustodian", path);
        }
    }
    protected void OnSelectedIndexChangedCategory(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "OnSelectedIndexChangedCategory", path);
    ...
    protected void OnSelectedIndexChangedLcocation(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "OnSelectedIndexChangedLcocation", path);
        }
    }
    ...
    protected void OnSelectedIndexChangedBuilding(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "OnSelectedIndexChangedBuilding", path);
        }
    }
    ...
    protected void btnsearchsubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "btnsearchsubmit_Click", path);
        }
    }
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "btnSearch_Click", path);
        }
    }
    private void ResetSearch()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "ResetSearch", path);
        }
    }
    protected void btnRefresh_Click(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "btnRefresh_Click", path);
        }
    }
    ...
    private void grid_view()
    {
        try
        {
            ...
            DataSet ds = Common.GetAssetDetailsForTagingV2(Asset, CategoryId, SubCatId, LocationId, BuildingId, FloorId, DepartmentId, AssetCode, CustodianId, SearchText, Session["userid"].ToString());
            ...
            if (hdnScanned.Value != "")
            {
                ...
                else
                {
                    ...
                    //string Message = "Scanned " + Assets + " not found";
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "grid_view", path);
    ...
    protected void gvData_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "gvData_NeedDataSource", path);
        }
    }
    ...
    protected void gvData_DataBinding(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "gvData_DataBinding", path);
        }
    }
    ...
    protected void gvData_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "gvData_ItemDataBound", path);
        }
    }
    ...
    protected void gvData_ItemCreated(object sender, GridItemEventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "gvData_ItemCreated", path);
        }
    }
    ...
    protected void btnConfirm_Click(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "btnConfirm_Click", path);
        }
    }
    ...
    protected void btnTag_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            foreach (GridDataItem item in gvData.Items)
            {
                ...
                if (chkitem.Checked == true)
                {
                    if (CheckedItem == "")
                    {
                        CheckedItem = "'" + hdnAstID.Value + "'";
                    }
                    else
                    {
                        CheckedItem = CheckedItem + ",'" + hdnAstID.Value + "'";
                    }
                }
            }
            if (CheckedItem == "")
            ...
            {
                if ((objAsset.UpdateAssetTaggedTSB(CheckedItem, 1)) == true)
                {
                    grid_view();
                    gvData.DataBind();
                    string Message = "The " + Assets + " was successfully taged.";
                ...
                {
                    string Message = "The " + Assets + " was not taged.";
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "AssetsTaging.aspx", "btnTag_Click", path);
        }
    }
