...
public partial class LabelPrint : System.Web.UI.Page
{
    ...
    protected void gvData_Init(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "gvData_Init", path);
        }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "Page_Load", path);
    ...
    public void SetGridOrder()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "SetGridOrder", path);
        }
    }
    ...
    private void bindCustodian()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "bindCustodian", path);
        }
    }
    protected void OnSelectedIndexChangedCategory(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "OnSelectedIndexChangedCategory", path);
    ...
    protected void OnSelectedIndexChangedLcocation(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "OnSelectedIndexChangedLcocation", path);
        }
    }
    ...
    protected void OnSelectedIndexChangedBuilding(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "OnSelectedIndexChangedBuilding", path);
        }
    }
    ...
    protected void btnsearchsubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "btnsearchsubmit_Click", path);
        }
    }
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "btnSearch_Click", path);
        }
    }
    private void ResetSearch()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "ResetSearch", path);
        }
    }
    protected void btnRefresh_Click(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "btnRefresh_Click", path);
        }
    }
    protected void btnConfirmPrint_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                //ObjPrint.UpdateAssetMasterPrintStatus(AssetID, Convert.ToInt32(Session["userid"]),"Print");

                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["connectionString"].ConnectionString))
                {
                    using (SqlCommand cmd = new SqlCommand("UpdateAssetMasterPrintStatus", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;

                        cmd.Parameters.Add("@AssetID", SqlDbType.VarChar).Value = AssetID;
                        cmd.Parameters.Add("@UserID", SqlDbType.VarChar).Value = Convert.ToInt32(Session["userid"]);
                        cmd.Parameters.Add("@Source", SqlDbType.VarChar).Value = "Print";
            ...
            catch (Exception ex)
            {
                ...
                Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "gvData_ItemCreated", path);
            }
    ...
    private void grid_view()
    {
        try
        {
            ...
            DataSet ds = Common.GetAssetDetailsForPrintV2(Asset, CategoryId, SubCatId, LocationId, BuildingId, FloorId, DepartmentId, AssetCode, CustodianId, SearchText, TagType, Session["userid"].ToString());
        ...
        catch (Exception ex)
        {
            ...
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "grid_view", path);
        }
    }
    ...
    protected void gvData_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "gvData_NeedDataSource", path);
    ...
    protected void HeaderCheckBox_CheckedChanged(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "HeaderCheckBox_CheckedChanged", path);
        }
    }
    ...
    protected void gvData_PageIndexChanged(object sender, Telerik.Web.UI.GridPageChangedEventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "gvData_PageIndexChanged", path);
        }
    }
    ...
    protected void btnPreview_Click(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "btnPreview_Click", path);
            ex.Message.ToString();
        }
    }
    ...
    protected void gvData_DataBinding(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "gvData_DataBinding", path);
        }
    }
    ...
    private void BinTagType()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "BinTagType", path);
        }
    }
    ...
    protected void ddlTagType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "ddlTagType_SelectedIndexChanged", path);
        }
    }
    //Added By ponraj
    protected void gvData_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "LabelPrint.aspx", "gvData_ItemDataBound", path);
        }
    }
