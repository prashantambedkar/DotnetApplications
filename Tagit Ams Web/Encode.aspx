<%@ Page Title="" Language="C#" MasterPageFile="~/adminMasterPage.master" AutoEventWireup="true"
    CodeFile="Encode.aspx.cs" Inherits="Encode" %>
            ...
            <div>
                <div class="main-content-inner">
                    <span style="font-size: large; font-family: cambriya; font-weight: bold; padding-left: 42%;
                        color: Blue;">FILTER ASSETS FOR ENCODE</span>
        ...
        <div class="page-content">
            ...
            <div class="row">
                ...
                <div class="form-group" id="divImport" runat="server">
                    <asp:UpdatePanel ID="ui_updpnl" runat="server">
                        <ContentTemplate>
                            <div class="col-xs-12">
                                <label runat="server" id="lblimgbrs" class="col-sm-2 control-label no-padding-right"
                                    for="form-field-1">
                                    <span style="font-weight: bold;">Import File for Sync</span>
                                </label>
                                <div class="col-sm-3">
                        ...
                        <Triggers>
                            <asp:PostBackTrigger ControlID="BtnSyncTHR" />
            ...
            <table width="80%">
                <tr align="center">
                    ...
                    <td style="background-color: #d0f2bc; width: 20px">
                        <div>
                    ...
                    <td style="background-color: #f2f1bc; width: 20px">
                        <div>
                            Encoded with THS
                        </div>
                    </td>
