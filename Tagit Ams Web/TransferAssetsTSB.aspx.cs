...
public partial class TransferAssetsTSB : System.Web.UI.Page
{
    ...
    private void bindFromCustodian()
    {
        try
        {
            ...
            cboFromCustodian.DataValueField = "CustodianCode";
            cboFromCustodian.DataBind();
            cboFromCustodian.Items.Insert(0, new ListItem("", "0", true));

            cboLocaCustodian.DataSource = ds;
            cboLocaCustodian.DataTextField = "CustodianName";
            cboLocaCustodian.DataValueField = "CustodianCode";
            cboLocaCustodian.DataBind();
            cboLocaCustodian.Items.Insert(0, new ListItem("", "0", true));
        }
        catch (Exception ex)
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "bindFromCustodian", path);
    ...
    protected void gvData_PageIndexChanged(object sender, Telerik.Web.UI.GridPageChangedEventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "gvData_PageIndexChanged", path);
        }
    }
    ...
    protected void gvData_Init(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "gvData_Init", path);
        }
    }
        ...
        try
        {
            ...
            if (FromCustodian != null)
            {
                ...
                if (dt_filter.Length > 0)
                {
                    ...
                    cboToCustodian.DataValueField = "CustodianCode";
            ...
            else
            {
                ...
                cboToCustodian.DataValueField = "CustodianCode";
                cboToCustodian.DataBind();
                cboToCustodian.Items.Insert(0, new ListItem("", "0", true));
            }
        }
        catch (Exception ex)
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "bindToCustodian", path);
        }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (userAuthorize((int)pages.Transfer_TSB, Session["userid"].ToString()) == true)
                {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "Page_Load", path);
        }
    }
    public void SetGridOrder()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "SetGridOrder", path);
        }
    }
    ...
    private void bindCustodian()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "bindCustodian", path);
        }
    }
    private void Bincategory()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "Bincategory", path);
        }
    }
    private void bindlocation()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "bindlocation", path);
        }
    }
    ...
    private void bindTolocation()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "bindTolocation", path);
        }
    }
    ...
    private void BindDepartment()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "BindDepartment", path);
        }
    }
    protected void OnSelectedIndexChangedCategory(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "OnSelectedIndexChangedCategory", path);
        }
    }
    ...
    protected void OnSelectedIndexChangedLocation(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "OnSelectedIndexChangedLocation", path);
        }
    }
    ...
    protected void OnSelectedIndexChangedToLocation(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "OnSelectedIndexChangedToLocation", path);
        }
    }
    ...
    protected void OnSelectedIndexChangedBuilding(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "OnSelectedIndexChangedBuilding", path);
        }
    }
    ...
    protected void OnSelectedIndexChangedToBuilding(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "OnSelectedIndexChangedToBuilding", path);
        }
    }
    ...
    private void grid_view()
    {
        ...
        {
            DataAccessHelper1 help = new DataAccessHelper1(
        StoredProcedures.GetAssetsAccordingToDateandType_1, new SqlParameter[] {
            ...
            else
            {
                ...
                if (hdnScanned.Value != "")
                {
                    ...
                    //{
                    DataView myView1;
                    myView1 = ds.Tables[0].DefaultView;
                    myView1.RowFilter = "AssetCode in ( " + scanned + ")";
                    if (StrSort != "")
                    {
                        myView.Sort = StrSort;
                    }
                    gvData.DataSource = myView1;
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "grid_view", path);
            ////lblMsg.Visible = true;
    ...
    DataSet ds = new DataSet();
    public static DataTable dzt = new DataTable();
    SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["connectionString"].ConnectionString);
    private void grid_view1()
    {
        string CategoryId = (ddlproCategory.SelectedValue == "0") ? null : ddlproCategory.SelectedValue;
        string SubCatId = null;
        string LocationId = (ddlloc.SelectedValue == "0") ? null : ddlloc.SelectedValue;
        ...
        try
        {
            ...
            {
                if (st[j].ToString().Trim().Length > 0)
                {

                    using (SqlCommand cmd1 = new SqlCommand("GetAssetsAccordingToDateandType_1", con))
                    {
                        cmd1.CommandType = CommandType.StoredProcedure;
                        cmd1.Parameters.AddWithValue("@CategoryId", CategoryId);
                        cmd1.Parameters.AddWithValue("@SubCatId", SubCatId);
                        ...
                        cmd1.Parameters.AddWithValue("@DepartmentId", DepartmentId);
                        cmd1.Parameters.AddWithValue("@FromDate", null);
                        cmd1.Parameters.AddWithValue("@Todate", null);
                        cmd1.Parameters.AddWithValue("@CustodianId", CustodianId);
                        cmd1.Parameters.AddWithValue("@AssetCode", AssetCode);
                        cmd1.Parameters.AddWithValue("@SearchText", st[j].ToString());
                    ...
                    //          new SqlParameter("@Todate",  null),
                    //          new SqlParameter("@AssetCode",  AssetCode),
                    //          new SqlParameter("@SearchText",  st[j].ToString()),
                    //          new SqlParameter("@CustodianId",  CustodianId),
                    //                    });
            ...
            else
            {
                ...
                if (hdnScanned.Value != "")
                {
                    ...
                    //DataView myView;
                    //myView = ds.Tables[0].DefaultView;
                    //myView.RowFilter = "AssetCode in ( " + scanned + ")";
                    //if (StrSort != "")
                    //{
                    //    myView.Sort = StrSort;
                    //}
    ...
    private void clear()
    {
        try
        {
            ...
            HdnTo.Value = "";
            HdnFrom.Value = "";
            HdnSelectedTo.Value = "0";
            HdnSelectedFrom.Value = "0";
            hdnScanned.Value = "";
            txtSearch.Text = "";

            cboLocaCustodian.SelectedIndex = 0;
            HdnCustLoc.Value = "";
            HdnSelectedCustLoc.Value = "0";
            grid_view();
            gvData.DataBind();
        }
        catch (Exception ex)
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "clear", path);
        }
    }
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "btnsubmit_Click", path);
        }
    }
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "btnExport_Click", path);
        }
    }
    private void ExportToExcel()
    {
        try
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pozp1", "setvalueforlocation('No Record Found');", true);
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "openModal();", true);
            }
        }
        catch (Exception ex)
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "ExportToExcel", path);
        }
    }
    ...
    private void PrepareForExport(Control ctrl)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "PrepareForExport", path);
        }
    }
    ...
    protected void gvData_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "gvData_NeedDataSource", path);
        }
    }
    ...
    protected void btnCustodianTransfer_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (HdnFrom.Value == "" || HdnTo.Value == "")
            {
                ...
                //trfooter.BgColor = "#98CODA";
                //ModalPopupExtender2.Show();
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pozp1", "setvalueforlocation('Select Custodian');", true);
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "openModal();", true);
                return;
            }
            ...
            foreach (GridDataItem item in gvData.Items)
            {
                ...
                if (chkitem.Checked == true)
                {
                    ...
                    if (hdnAstID.Value == "" || hdnAstID.Value == string.Empty)
                    {
                        ...
                        sw.WriteLine("Error-TransferAssetsTSB_Custodian_Web- Hidden field hdnAstID Value is Empty -" + Session["UserName"].ToString() + "-" + DateTime.Now.ToString());
                        sw.Close();
                    }
                }
            }
            ...
            {
                StreamWriter sw = new StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\ErroLogFile.txt", true);
                sw.WriteLine("Error-TransferAssetsTSB_Custodian_Web- Checked Rows NOT Found from Grid -" + Session["UserName"].ToString() + "-" + DateTime.Now.ToString());
                sw.Close();
            }
            ...
            {
                StreamWriter sw = new StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\ErroLogFile.txt", true);
                sw.WriteLine("Error-TransferAssetsTSB_Custodian_Web- dt_search Table is Empty -" + Session["UserName"].ToString() + "-" + DateTime.Now.ToString());
                sw.Close();
            }
            ...
            {
                StreamWriter sw = new StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\ErroLogFile.txt", true);
                sw.WriteLine("Error-TransferAssetsTSB_Custodian_Web- results Table is Empty (Linq Query) -" + Session["UserName"].ToString() + "-" + DateTime.Now.ToString());
                sw.Close();
                ...
                //trfooter.BgColor = "#98CODA";
                //ModalPopupExtender2.Show();
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pozp1", "setvalueforlocation('Select '" + Assets + ");", true);
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "openModal();", true);
                return;
            }
            ...
            //added by ponraj
            int CustID = objVer.GetCustordianID(HdnSelectedTo.Value.ToString());
            objVer.SendAssets_For_Approval(dt_Transfer, Session["userid"].ToString(), Asset_Transfer_ID, txtReasonCusChange.Text, "", "", "", "", Session["UserName"].ToString(), "Custodian Transfer", HdnFrom.Value.ToString(), HdnTo.Value.ToString(), CustID.ToString(), "TSB Transfer", HdnLocation.Value.ToString());
            ...
            dttableNew.Columns.Remove("Column15");
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "btnCustodianTransfer_Click", path);
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (cboLoc.SelectedItem.ToString() != Dispose)
            {
                if (cboBuild.SelectedIndex == 0 || cboFloor.SelectedIndex == 0 || cboLoc.SelectedIndex == 0)
                {
                    ...
                    //trfooter.BgColor = "#98CODA";
                    //ModalPopupExtender2.Show();
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Pozp1", "setvalueforlocation('Select Destination Location');", true);
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "openModal();", true);
                    return;
                }
            }
            ...
            foreach (GridDataItem item in gvData.Items)
            {
                ...
                if (chkitem.Checked == true)
                {
                    ...
                    {
                        StreamWriter sw = new StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\ErroLogFile.txt", true);
                        sw.WriteLine("Error-TransferAssetsTSB_Location_Web- Hidden field hdnAstID Value is Empty -" + Session["UserName"].ToString() + "-" + DateTime.Now.ToString());
                        sw.Close();
                    }
                }
            }
            ...
            {
                StreamWriter sw = new StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\ErroLogFile.txt", true);
                sw.WriteLine("Error-TransferAssetsTSB_Location_Web- Checked Rows NOT Found from Grid -" + Session["UserName"].ToString() + "-" + DateTime.Now.ToString());
                sw.Close();
            }
            ...
            {
                StreamWriter sw = new StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\ErroLogFile.txt", true);
                sw.WriteLine("Error-TransferAssetsTSB_Location_Web- dt_search Table is Empty -" + Session["UserName"].ToString() + "-" + DateTime.Now.ToString());
                sw.Close();
            }
            ...
            {
                StreamWriter sw = new StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\ErroLogFile.txt", true);
                sw.WriteLine("Error-TransferAssetsTSB_Location_Web- results Table is Empty (Linq Query) -" + Session["UserName"].ToString() + "-" + DateTime.Now.ToString());
                sw.Close();
            ...
            if (cboLoc.SelectedItem.ToString() == Dispose)
            {
                ...
                objVer.SendAssets_For_Approval(dt_Transfer, Session["userid"].ToString(), Asset_Transfer_ID, txtReasonLocChange.Text, ToDestination, cboLoc.SelectedValue.ToString(), "1", "1", Session["UserName"].ToString(), "Location Transfer", "", "", null, "TSB Transfer", HdnLocation.Value.ToString());
                //ClientScript.RegisterClientScriptBlock(this.GetType(), "alert", "alert('Asset sent for approval successfully.');", true);


                //string Messages = Assets + " sent for approval successfully.";
            ...
            {
                objVer.SendAssets_For_Approval(dt_Transfer, Session["userid"].ToString(), Asset_Transfer_ID, txtReasonLocChange.Text, ToDestination, cboLoc.SelectedValue.ToString(), cboBuild.SelectedValue.ToString(), cboFloor.SelectedValue.ToString(), Session["UserName"].ToString(), "Location Transfer", "", "", null, "TSB Transfer", HdnLocation.Value.ToString());
                //ClientScript.RegisterClientScriptBlock(this.GetType(), "alert", "alert('Asset sent for approval successfully');", true);
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "Button1_Click", path);
        }
    }
    ...
    protected void cboFromCustodian_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "cboFromCustodian_SelectedIndexChanged", path);
            ex.Message.ToString();
        }
    ...
    protected void gvData_ItemDataBound(object sender, GridItemEventArgs e)
    {
        try
        {
            ...
            if (e.Item is GridDataItem)
            {
                ...
                if (HdnSelectedFrom.Value != "0" && hidTAB.Value == "divbyCustodian")
                {

                    if (dataItem["CustodianCode"].Text != HdnSelectedFrom.Value)
                    {
                    ...
                    {
                        dataItem.BackColor = System.Drawing.Color.Empty;
                ...
                {
                    if (HdnSelectedCustLoc.Value != "0")
                    {
                        //CheckBox chkbox = dataItem.FindControl("cboxSelect") as CheckBox;
                        // chkbox.Checked = true;
                        if (dataItem["CustodianCode"].Text != HdnSelectedCustLoc.Value)
                        {
                            dataItem.BackColor = System.Drawing.Color.Red;
                            dataItem.Enabled = false;
                            //chkbox.Checked = false;
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "gvData_ItemDataBound", path);
    ...
    protected void gvData_ItemCreated(object sender, GridItemEventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "gvData_ItemCreated", path);
        }
    }
    ...
    protected void btnConfirm_Click(object sender, EventArgs e)
    {
        try
        {
            // txtSearch.Text = hdnScanned.Value;
            grid_view();
            gvData.DataBind();
            // txtSearch.Text = "";
            txtAreaScannedItems.Text = "";
            ...
            {
                CheckBox chkbox = item.FindControl("cboxSelect") as CheckBox;
                if (HdnSelectedFrom.Value != "0" && hidTAB.Value == "divbyCustodian")
                {
                    if (item["CustodianCode"].Text != HdnSelectedFrom.Value)
                    {
                        chkbox.Checked = false;
                    }
                    else
                ...
                else
                {
                    if (HdnSelectedCustLoc.Value != "0")
                    {
                        if (item["CustodianCode"].Text != HdnSelectedCustLoc.Value)
                        {
                            chkbox.Checked = false;
                        }
                        else
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "btnConfirm_Click", path);
        }
    }
    ...
    protected void BtnByLocation_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //BtnByLocation.CssClass = "btn btn-primary targetButton";
            //BtnByCustodian.CssClass = "btn btn-primary";
            //ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "script", "Oncall();", true);
        }
        catch (Exception ex)
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "BtnByLocation_Click", path);
        }
    }
    ...
    protected void BtnByCustodian_Click(object sender, EventArgs e)
    {
        try
        {
            hidTAB.Value = "divbyCustodian";
            grid_view();
            gvData.DataBind();
            txtAreaScannedItems.Text = "";
            hdnScanned.Value = "";
            //BtnByLocation.CssClass = "btn btn-primary";
            //BtnByCustodian.CssClass = "btn btn-primary targetButton";
        }
        catch (Exception ex)
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "BtnByCustodian_Click", path);
        }
    }

    protected void btnfromCustordian_Click(object sender, EventArgs e)
    {
        try
        {
            // grid_view();
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "btnfromCustordian_Click", path);
        }
    }
    ...
    public static void RetrieveFormatedAddress(string lat, string lng)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "RetrieveFormatedAddress", path);
        }
    }
    ...
    public void GetGPSLocation()
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "GetGPSLocation", path);
        }
    }
    protected void gvData_DataBinding(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "gvData_DataBinding", path);
        }
    }
    ...
    protected void GetGrid_Click(object sender, EventArgs e)
    {
        ...
        {
            Logging.WriteErrorLog(ex.Message.ToString(), ex.StackTrace.ToString(), "TransferAssetsTSB.aspx", "GetGrid_Click", path);
        }
    }
}